...
> [!INFO] This post was last updated on February 10, 2026. If you have any suggestions for extensions to add to this list, feel free to reach out to me!
...
> [!TIP]- The "Disable JavaScript" feature can unlock paywalls on news sites
...
> [!CAUTION] UBO works on Edge (as of writing) and Firefox, but not Chrome. UBO Lite is a limited, but futureproof version.

UBO: https://ublockorigin.com/ <br>
...
## **Monolith**
A simple extension that allows you to save any webpage as a single HTML file, including all images. This is much better than the built-in "Save as webpage" feature in browsers, which creates a separate folder for images and can break if you move the HTML file. Monolith is a [CLI Tool](https://github.com/Y2Z/monolith), but the unofficial browser extension is a convenient way to use it without needing to install anything on your system.
